...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.delegate && [(NSObject *)self.delegate respondsToSelector:@selector(dropDown:heightForRow:)]) {
        return [self.delegate dropDown:self heightForRow:indexPath];
    }
    return 40;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [(NSObject *)self.delegate respondsToSelector:@selector(dropDown:didSelectRow:)]) {
        [self.delegate dropDown:self didSelectRow:indexPath];
    }
}
//master
